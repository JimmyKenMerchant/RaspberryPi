...
math32_crc7:
	...
	math32_crc7_calculate:
		tst dividend, #0x80
		beq math32_crc7_calculate_shift

		eor dividend, dividend, divisor

		math32_crc7_calculate_shift:
			cmp i, number_bit
			bhs math32_crc7_common

			cmp count_bit, #8
			blo math32_crc7_calculate_shift_jump
			...
			math32_crc7_calculate_shift_jump:
...
math32_crc16:
	...
	math32_crc16_calculate:
		cmp i, number_bit
		bhs math32_crc16_common

		cmp count_bit, #8
		blo math32_crc16_calculate_jump
