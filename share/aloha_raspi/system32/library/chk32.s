 ...
 * r3: Number of Bits Actually Checked, From 15
 *
...
chk32_crc7:
	...
	mov count_byte, #0
	/* Assumes Initial Value is Zero to XOR with Loaded Value */
 ...
 * r3: Number of Bits Actually Checked, From 16
 *
 * Return: r0 (Calculated Value, -1 as Error)
 * Error: Length of Bits as Divisor Exceeds Length of Data
 */
 ...
 * r2: Bits as Divisor (Polynomial), Omit Bit[16] (Always High) to Hide Overflow
 * r3: Number of Bits Actually Checked, From 24
 *
 * Return: r0 (Calculated Value, -1 as Error)
 * Error: Length of Bits as Divisor Exceeds Length of Data
 */
