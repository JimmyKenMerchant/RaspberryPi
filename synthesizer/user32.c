...
synthe_precode pre_synthe1_l[] = {
	_3_BIG(_RAP(
		_2(_RAP(
			_NOISE<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|5000<<_MAG,1000<<_BEAT,30<<_RIS|70<<_FAL
		))
		_2(_RAP(
			_G6<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|6000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL,
			_B6<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|6000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL,
			_D7<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|6000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL,
			_B6<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|6000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL
		))
			_2(_RAP(
			_C6<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|7000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL,
			_E6<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|7000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL,
			_G6<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|7000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL,
			_E6<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|7000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL
		))
		_2(_RAP(
			_D6<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|8000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL,
			_F6<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|8000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL,
			_A6<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|8000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL,
			_F6<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|8000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL
		))
	))
	_END
...
synthe_precode pre_synthe1_r[] = {
	_3_BIG(_RAP(
		_2(_RAP(
			_D7<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|1000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL,
			_F7<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|1000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL,
			_A7<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|1000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL,
			_F7<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|1000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL
		))
		_2(_RAP(
			_G7<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|2000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL,
			_B7<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|2000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL,
			_D8<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|2000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL,
			_B7<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|2000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL
		))
		_2(_RAP(
			_C7<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|3000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL,
			_E7<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|3000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL,
			_G7<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|3000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL,
			_E7<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|3000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL
		))
		_2(_RAP(
			_D7<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|4000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL,
			_F7<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|4000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL,
			_A7<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|4000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL,
			_F7<<_FREQ|5000<<_MAG,_NOISE<<_FREQ|4000<<_MAG,250<<_BEAT,30<<_RIS|70<<_FAL
		))
	))
	_END
...
synthe_precode pre_synthe2_l[] = {
	// One, Two, Three
	_3(_RAP(
		_D6<<_FREQ|1250<<_MAG,_D7<<_FREQ|15000<<_MAG,125<<_BEAT,1<<_RIS|99<<_FAL,
		_D6<<_FREQ|0000<<_MAG,_D7<<_FREQ|15000<<_MAG,125<<_BEAT,1<<_RIS|99<<_FAL,
		_D6<<_FREQ|1250<<_MAG,_D7<<_FREQ|15000<<_MAG,125<<_BEAT,1<<_RIS|99<<_FAL,
		_D6<<_FREQ|0000<<_MAG,_D7<<_FREQ|15000<<_MAG,125<<_BEAT,1<<_RIS|99<<_FAL,
		_D6<<_FREQ|5000<<_MAG,_D7<<_FREQ|15000<<_MAG,125<<_BEAT,1<<_RIS|99<<_FAL,
		_D6<<_FREQ|0000<<_MAG,_D7<<_FREQ|15000<<_MAG,125<<_BEAT,1<<_RIS|99<<_FAL,
		_D6<<_FREQ|1250<<_MAG,_D7<<_FREQ|15000<<_MAG,125<<_BEAT,1<<_RIS|99<<_FAL,
		_D6<<_FREQ|0000<<_MAG,_D7<<_FREQ|15000<<_MAG,125<<_BEAT,1<<_RIS|99<<_FAL,
		_D6<<_FREQ|1250<<_MAG,_D7<<_FREQ|15000<<_MAG,125<<_BEAT,1<<_RIS|99<<_FAL,
	...
	_1(_RAP(
		...
		_D6<<_FREQ|1250<<_MAG,_D7<<_FREQ|15000<<_MAG,125<<_BEAT,1<<_RIS|99<<_FAL,
		_D6<<_FREQ|0000<<_MAG,_D7<<_FREQ|15000<<_MAG,125<<_BEAT,1<<_RIS|99<<_FAL,
		_D6<<_FREQ|1200<<_MAG,_D7<<_FREQ|15000<<_MAG,125<<_BEAT,1<<_RIS|99<<_FAL,
		_D6<<_FREQ|0000<<_MAG,_D7<<_FREQ|15000<<_MAG,125<<_BEAT,1<<_RIS|99<<_FAL,
		_D6<<_FREQ|5000<<_MAG,_D7<<_FREQ|15000<<_MAG,125<<_BEAT,1<<_RIS|99<<_FAL,
		_D6<<_FREQ|0000<<_MAG,_D7<<_FREQ|15000<<_MAG,125<<_BEAT,1<<_RIS|99<<_FAL,

		_D6<<_FREQ|5000<<_MAG,_D7<<_FREQ|15000<<_MAG,250<<_BEAT,1<<_RIS|99<<_FAL,
...
synthe_precode pre_synthe2_r[] = {
	...
	_3(_RAP(
		...
		_D1<<_FREQ|0000<<_MAG,_D1<<_FREQ|15000<<_MAG,125<<_BEAT,1<<_RIS|99<<_FAL,
		_A4<<_FREQ|5000<<_MAG,_B4<<_FREQ|15000<<_MAG,125<<_BEAT,1<<_RIS|99<<_FAL,
		_D1<<_FREQ|0000<<_MAG,_D1<<_FREQ|15000<<_MAG,125<<_BEAT,1<<_RIS|99<<_FAL,
		_D1<<_FREQ|0000<<_MAG,_D1<<_FREQ|15000<<_MAG,125<<_BEAT,1<<_RIS|99<<_FAL,
		_A4<<_FREQ|125<<_MAG,_B4<<_FREQ|15000<<_MAG,125<<_BEAT,1<<_RIS|99<<_FAL,
		_D1<<_FREQ|0000<<_MAG,_D1<<_FREQ|15000<<_MAG,125<<_BEAT,1<<_RIS|99<<_FAL,
		_A4<<_FREQ|125<<_MAG,_B4<<_FREQ|15000<<_MAG,125<<_BEAT,1<<_RIS|99<<_FAL,
		_B1<<_FREQ|10000<<_MAG,_B1<<_FREQ|00000<<_MAG,250<<_BEAT,1<<_RIS|99<<_FAL,
		_D1<<_FREQ|0000<<_MAG,_D1<<_FREQ|15000<<_MAG,125<<_BEAT,1<<_RIS|99<<_FAL,
...
synthe_precode pre_synthe4_l[] = {
	_4(_RAP(
		_C4<<_FREQ|5000<<_MAG,_G4<<_FREQ|5000<<_MAG,250<<_BEAT,50<<_RIS|50<<_FAL,
		_E4<<_FREQ|5000<<_MAG,_B4<<_FREQ|5000<<_MAG,250<<_BEAT,50<<_RIS|50<<_FAL,
		_G4<<_FREQ|5000<<_MAG,_D5<<_FREQ|5000<<_MAG,250<<_BEAT,50<<_RIS|50<<_FAL,
		_E4<<_FREQ|5000<<_MAG,_B4<<_FREQ|5000<<_MAG,250<<_BEAT,50<<_RIS|50<<_FAL
	))
	_4(_RAP(
		_F4<<_FREQ|5000<<_MAG,_C5<<_FREQ|5000<<_MAG,250<<_BEAT,50<<_RIS|50<<_FAL,
		_A4<<_FREQ|5000<<_MAG,_E5<<_FREQ|5000<<_MAG,250<<_BEAT,50<<_RIS|50<<_FAL,
		_C5<<_FREQ|5000<<_MAG,_G5<<_FREQ|5000<<_MAG,250<<_BEAT,50<<_RIS|50<<_FAL,
		_A4<<_FREQ|5000<<_MAG,_E5<<_FREQ|5000<<_MAG,250<<_BEAT,50<<_RIS|50<<_FAL
	))
	_4(_RAP(
		_G4<<_FREQ|5000<<_MAG,_D5<<_FREQ|5000<<_MAG,250<<_BEAT,50<<_RIS|50<<_FAL,
		_B4<<_FREQ|5000<<_MAG,_FS5<<_FREQ|5000<<_MAG,250<<_BEAT,50<<_RIS|50<<_FAL,
		_D5<<_FREQ|5000<<_MAG,_A5<<_FREQ|5000<<_MAG,250<<_BEAT,50<<_RIS|50<<_FAL,
		_B4<<_FREQ|5000<<_MAG,_FS5<<_FREQ|5000<<_MAG,250<<_BEAT,50<<_RIS|50<<_FAL
	))
	_4(_RAP(
		_C4<<_FREQ|5000<<_MAG,_G4<<_FREQ|5000<<_MAG,250<<_BEAT,50<<_RIS|50<<_FAL,
...
synthe_precode pre_synthe4_r[] = {
	_4(_RAP(
		_B4<<_FREQ|5000<<_MAG,_E4<<_FREQ|5000<<_MAG,250<<_BEAT,50<<_RIS|50<<_FAL,
		_DS5<<_FREQ|5000<<_MAG,_GS4<<_FREQ|5000<<_MAG,250<<_BEAT,50<<_RIS|50<<_FAL,
		_FS5<<_FREQ|5000<<_MAG,_B4<<_FREQ|5000<<_MAG,250<<_BEAT,50<<_RIS|50<<_FAL,
		_DS5<<_FREQ|5000<<_MAG,_GS4<<_FREQ|5000<<_MAG,250<<_BEAT,50<<_RIS|50<<_FAL
	))
	_4(_RAP(
		_E5<<_FREQ|5000<<_MAG,_A4<<_FREQ|5000<<_MAG,250<<_BEAT,50<<_RIS|50<<_FAL,
		_GS5<<_FREQ|5000<<_MAG,_CS5<<_FREQ|5000<<_MAG,250<<_BEAT,50<<_RIS|50<<_FAL,
		_B5<<_FREQ|5000<<_MAG,_E5<<_FREQ|5000<<_MAG,250<<_BEAT,50<<_RIS|50<<_FAL,
		_GS5<<_FREQ|5000<<_MAG,_CS5<<_FREQ|5000<<_MAG,250<<_BEAT,50<<_RIS|50<<_FAL
	))
	_4(_RAP(
		_FS5<<_FREQ|5000<<_MAG,_B4<<_FREQ|5000<<_MAG,250<<_BEAT,50<<_RIS|50<<_FAL,
		_AS5<<_FREQ|5000<<_MAG,_DS5<<_FREQ|5000<<_MAG,250<<_BEAT,50<<_RIS|50<<_FAL,
		_CS6<<_FREQ|5000<<_MAG,_FS5<<_FREQ|5000<<_MAG,250<<_BEAT,50<<_RIS|50<<_FAL,
		_AS5<<_FREQ|5000<<_MAG,_DS5<<_FREQ|5000<<_MAG,250<<_BEAT,50<<_RIS|50<<_FAL
	))
	_4(_RAP(
		_B4<<_FREQ|5000<<_MAG,_E4<<_FREQ|5000<<_MAG,250<<_BEAT,50<<_RIS|50<<_FAL,
...
synthe_precode pre_synthe5_l[] = {
	_1(_RAP(
		_B2_INT<<_FREQ|7000<<_MAG,(_B2_INT>>2)<<_FREQ|30000<<_MAG,2000<<_BEAT,50<<_RIS|50<<_FAL
	))
	_END
};
...
synthe_precode pre_synthe8_l[] = {
	_4(_RAP(
		_D4_INT<<_FREQ|5000<<_MAG,(_D4_INT>>2)<<_FREQ|15000<<_MAG,250<<_BEAT,1<<_RIS|99<<_FAL,
		_G5_INT<<_FREQ|5000<<_MAG,(_G5_INT>>2)<<_FREQ|15000<<_MAG,250<<_BEAT,1<<_RIS|99<<_FAL,
		_D4_INT<<_FREQ|0000<<_MAG,(_D4_INT>>2)<<_FREQ|15000<<_MAG,250<<_BEAT,1<<_RIS|99<<_FAL,
		_G5_INT<<_FREQ|5000<<_MAG,(_G5_INT>>2)<<_FREQ|15000<<_MAG,250<<_BEAT,1<<_RIS|99<<_FAL
	))
	_4(_RAP(
		_C4_INT<<_FREQ|5000<<_MAG,(_C4_INT>>2)<<_FREQ|15000<<_MAG,250<<_BEAT,1<<_RIS|99<<_FAL,
		_F5_INT<<_FREQ|5000<<_MAG,(_F5_INT>>2)<<_FREQ|15000<<_MAG,250<<_BEAT,1<<_RIS|99<<_FAL,
...
synthe_precode pre_synthe8_r[] = {
	_4(_RAP(
		_D1_INT<<_FREQ|5000<<_MAG,(_D4_INT>>2)<<_FREQ|15000<<_MAG,250<<_BEAT,1<<_RIS|99<<_FAL,
		...
		_D1_INT<<_FREQ|5000<<_MAG,(_G5_INT>>2)<<_FREQ|15000<<_MAG,250<<_BEAT,1<<_RIS|99<<_FAL
	))
	_4(_RAP(
		_D1_INT<<_FREQ|5000<<_MAG,(_D4_INT>>2)<<_FREQ|15000<<_MAG,250<<_BEAT,1<<_RIS|99<<_FAL,
		_D1_INT<<_FREQ|0000<<_MAG,(_G5_INT>>2)<<_FREQ|15000<<_MAG,250<<_BEAT,1<<_RIS|99<<_FAL,
...
synthe_precode pre_synthe16_l[] = {
	_D5<<_FREQ|5000<<_MAG,_D7<<_FREQ|5000<<_MAG,750<<_BEAT,20<<_RIS|80<<_FAL,
	_G5<<_FREQ|5000<<_MAG,_G7<<_FREQ|5000<<_MAG,1250<<_BEAT,20<<_RIS|80<<_FAL,
	_D5<<_FREQ|5000<<_MAG,_D7<<_FREQ|5000<<_MAG,750<<_BEAT,20<<_RIS|80<<_FAL,
	_G5<<_FREQ|5000<<_MAG,_G7<<_FREQ|5000<<_MAG,1250<<_BEAT,20<<_RIS|80<<_FAL,
	_F5<<_FREQ|5000<<_MAG,_F7<<_FREQ|5000<<_MAG,750<<_BEAT,20<<_RIS|80<<_FAL,
	_C6<<_FREQ|5000<<_MAG,_C8<<_FREQ|5000<<_MAG,1250<<_BEAT,20<<_RIS|80<<_FAL,
	_G5<<_FREQ|5000<<_MAG,_G7<<_FREQ|5000<<_MAG,750<<_BEAT,20<<_RIS|80<<_FAL,
	_D6<<_FREQ|5000<<_MAG,_D8<<_FREQ|5000<<_MAG,1250<<_BEAT,20<<_RIS|80<<_FAL,
	_END
};

synthe_precode pre_synthe16_r[] = {
	_G1<<_FREQ|5000<<_MAG,_G1<<_FREQ|30000<<_MAG,500<<_BEAT,10<<_RIS|90<<_FAL,
	_D2<<_FREQ|5000<<_MAG,_D2<<_FREQ|30000<<_MAG,500<<_BEAT,10<<_RIS|90<<_FAL,
	_G1<<_FREQ|5000<<_MAG,_G1<<_FREQ|30000<<_MAG,500<<_BEAT,10<<_RIS|90<<_FAL,
	_D2<<_FREQ|5000<<_MAG,_D2<<_FREQ|30000<<_MAG,500<<_BEAT,10<<_RIS|90<<_FAL,
	_G1<<_FREQ|5000<<_MAG,_G1<<_FREQ|30000<<_MAG,500<<_BEAT,10<<_RIS|90<<_FAL,
	_D2<<_FREQ|5000<<_MAG,_D2<<_FREQ|30000<<_MAG,500<<_BEAT,10<<_RIS|90<<_FAL,
	_G1<<_FREQ|5000<<_MAG,_G1<<_FREQ|30000<<_MAG,500<<_BEAT,10<<_RIS|90<<_FAL,
	_D2<<_FREQ|5000<<_MAG,_D2<<_FREQ|30000<<_MAG,500<<_BEAT,10<<_RIS|90<<_FAL,
	_F1<<_FREQ|5000<<_MAG,_F1<<_FREQ|30000<<_MAG,500<<_BEAT,10<<_RIS|90<<_FAL,
	_C2<<_FREQ|5000<<_MAG,_C2<<_FREQ|30000<<_MAG,500<<_BEAT,10<<_RIS|90<<_FAL,
	_F1<<_FREQ|5000<<_MAG,_F1<<_FREQ|30000<<_MAG,500<<_BEAT,10<<_RIS|90<<_FAL,
	_C2<<_FREQ|5000<<_MAG,_C2<<_FREQ|30000<<_MAG,500<<_BEAT,10<<_RIS|90<<_FAL,
	_G1<<_FREQ|5000<<_MAG,_G1<<_FREQ|30000<<_MAG,500<<_BEAT,10<<_RIS|90<<_FAL,
	_D2<<_FREQ|5000<<_MAG,_D2<<_FREQ|30000<<_MAG,500<<_BEAT,10<<_RIS|90<<_FAL,
