...
synthe_precode pre_synthe8_l[] = {
	_4(_RAP(
		_D4_INT<<_FREQ|3000<<_MAG,(_D4_INT>>2)<<_FREQ|30000<<_MAG,250<<_BEAT,1<<_RIS|99<<_FAL,
		_G5_INT<<_FREQ|3000<<_MAG,(_G5_INT>>2)<<_FREQ|30000<<_MAG,250<<_BEAT,1<<_RIS|99<<_FAL,
		_D4_INT<<_FREQ|0000<<_MAG,(_D4_INT>>2)<<_FREQ|30000<<_MAG,250<<_BEAT,1<<_RIS|99<<_FAL,
		_G5_INT<<_FREQ|3000<<_MAG,(_G5_INT>>2)<<_FREQ|30000<<_MAG,250<<_BEAT,1<<_RIS|99<<_FAL
	))
	_4(_RAP(
		_C4_INT<<_FREQ|3000<<_MAG,(_C4_INT>>2)<<_FREQ|30000<<_MAG,250<<_BEAT,1<<_RIS|99<<_FAL,
		_F5_INT<<_FREQ|3000<<_MAG,(_F5_INT>>2)<<_FREQ|30000<<_MAG,250<<_BEAT,1<<_RIS|99<<_FAL,
...
synthe_precode pre_synthe8_r[] = {
	_4(_RAP(
		_D4_INT<<_FREQ|-3000<<_MAG,(_D4_INT>>2)<<_FREQ|30000<<_MAG,250<<_BEAT,1<<_RIS|99<<_FAL,
		_G5_INT<<_FREQ|-3000<<_MAG,(_G5_INT>>2)<<_FREQ|30000<<_MAG,250<<_BEAT,1<<_RIS|99<<_FAL,
		_D4_INT<<_FREQ|00000<<_MAG,(_D4_INT>>2)<<_FREQ|30000<<_MAG,250<<_BEAT,1<<_RIS|99<<_FAL,
		_G5_INT<<_FREQ|-3000<<_MAG,(_G5_INT>>2)<<_FREQ|30000<<_MAG,250<<_BEAT,1<<_RIS|99<<_FAL
	))
	_4(_RAP(
		_C4_INT<<_FREQ|-3000<<_MAG,(_C4_INT>>2)<<_FREQ|30000<<_MAG,250<<_BEAT,1<<_RIS|99<<_FAL,
		_F5_INT<<_FREQ|-3000<<_MAG,(_F5_INT>>2)<<_FREQ|30000<<_MAG,250<<_BEAT,1<<_RIS|99<<_FAL,
		_C4_INT<<_FREQ|00000<<_MAG,(_C4_INT>>2)<<_FREQ|30000<<_MAG,250<<_BEAT,1<<_RIS|99<<_FAL,
		_F5_INT<<_FREQ|-3000<<_MAG,(_F5_INT>>2)<<_FREQ|30000<<_MAG,250<<_BEAT,1<<_RIS|99<<_FAL
	))
	_END
};
